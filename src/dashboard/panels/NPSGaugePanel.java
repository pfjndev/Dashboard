...
public class NPSGaugePanel extends JPanel {
    private int npsScore = 72; // Example value out of 100

    public NPSGaugePanel() {
    ...
    protected void paintComponent(Graphics g) {
        ...
        // Draw the needle
        double needleAngle = Math.toRadians(135 - (270 * npsScore / 100.0));
        ...
        // Draw the NPS score in the center
        String npsText = npsScore + "%";
        g2d.setFont(new Font("Arial", Font.BOLD, 20));
        FontMetrics fm = g2d.getFontMetrics();
        int stringWidth = fm.stringWidth(npsText);
        g2d.setColor(Color.BLACK);
        g2d.drawString(npsText, centerX - stringWidth / 2, centerY + fm.getAscent() / 2);
    }
}
